...
const Register = () => {
  ...
  const { loading, user, success, error, dispatch } = useContext(AuthContext);
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      const res = await clientAxios.post("/auth/register", {
        username,
        password,
        email,
      });
              ...
              <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                ...
                <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                  <form onSubmit={handleClick}>
                    <h2 className="text-3xl font-extrabold mb-2 text-blue-700 text-center lg:text-left">
                      Register page with booking travel
                    </h2>
